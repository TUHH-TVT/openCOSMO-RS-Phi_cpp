...
void loadCalculationsOnCLI(const json& calculationsOnCLI) {
    ...
    for (int i = 0; i < numCalcs; i++) {
        ...
        cout << "lnGammaTotal_data 1 position:";
        cout << newCalculation.lnGammaTotal_data.data();
        cout << "\n";
        cout << "lnGammaTotal 1 position:";
        cout << newCalculation.lnGammaTotal.data();
        cout << "\n";
#endif
...
#ifdef PRINT_DEBUG_INFO
        cout << "lnGammaTotal_data 2 position:";
        cout << newCalculation.lnGammaTotal_data.data();
        cout << "\n";
        cout << "lnGammaTotal 2 position:";
        cout << newCalculation.lnGammaTotal.data();
        cout << "\n";
#endif
    }
